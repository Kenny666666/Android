package com.kenny.imageload.util;
    ...
    private Runnable buildTask(final String path, final ImageView imageView,
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                File file = null;
                if (isFromNet) {
                    file = getDiskCacheDir(imageView.getContext(),md5(path));
                ...
                //如果返回的bitmap为null说明加载硬盘图片或者网络下载图片出现问题，则直接删除文件重新创建任务去下载
                if (bm==null){
